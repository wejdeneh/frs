...
class SPIFFSParser:
    def __init__(self, filename, block_size=BLOCK_SIZE, page_size=PAGE_SIZE, verbose=False):
...
def main():
    ...
    parser = SPIFFSParser(args.image_file, block_size=args.block_size, page_size=args.page_size, verbose=args.verbose)
